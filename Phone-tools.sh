...
git clone https://github.com/spider863644/PhoneNumber-OSINT ~/.humint-tools/Inspector/phone-number-osint/
pip install -r ~/.humint-tools/Inspector/phone-number-osint/requirements.txt --break-system-packages
